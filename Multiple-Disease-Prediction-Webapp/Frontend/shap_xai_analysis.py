...
class SHAPAnalyzer:
    ...
    def plot_shap_summary(self, disease_name):
        ...
        plt.tight_layout()
        plt.savefig(f'shap_summary_{disease_name}.png', dpi=300, bbox_inches='tight')
        plt.close()
        print(f"  ✅ Summary plot saved: shap_summary_{disease_name}.png")
    ...
    def plot_shap_importance(self, disease_name):
        ...
        plt.tight_layout()
        plt.savefig(f'shap_importance_{disease_name}.png', dpi=300, bbox_inches='tight')
        plt.close()
        print(f"  ✅ Importance plot saved: shap_importance_{disease_name}.png")
    ...
    def plot_shap_dependence(self, disease_name):
        ...
        plt.tight_layout()
        plt.savefig(f'shap_dependence_{disease_name}.png', dpi=300, bbox_inches='tight')
        plt.close()
        print(f"  ✅ Dependence plots saved: shap_dependence_{disease_name}.png")
