"""
Fix the corrupted Model Comparison section in app.py
"""

# Read the original file
with open('Multiple-Disease-Prediction-Webapp/Frontend/app.py', 'r', encoding='utf-8') as f:
    lines = f.readlines()

# The clean Model Comparison section
clean_section = '''# Model Comparison Page
...
start_line = 2416  # 0-indexed, so line 2417 in editor
end_line = 2567    # 0-indexed, so line 2568 in editor

# Create the fixed file
fixed_lines = lines[:start_line] + [clean_section] + lines[end_line+1:]

# Write the fixed file
with open('Multiple-Disease-Prediction-Webapp/Frontend/app.py', 'w', encoding='utf-8') as f:
